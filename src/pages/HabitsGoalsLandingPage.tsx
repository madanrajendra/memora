...
export default function HabitsGoalsLandingPage() {
            ...
            <aside className="w-full md:w-72 border-r border-white/5 p-6 flex flex-col gap-8 bg-black/20">
              ...
              <nav className="flex flex-row md:flex-col overflow-x-auto md:overflow-x-visible gap-2 md:gap-1 pb-2 md:pb-0 scrollbar-hide">
                {navigationItems.map((item) => {
                  const isActive = item.label === 'Habit Loop';
                  return (
                    <Link
                      key={item.label}
                      to={item.route}
            ...
            <main className="flex-1 flex flex-col relative bg-[#050505]">
              ...
              <div className="flex-1 flex flex-col p-8">
                <div className="mt-4 mb-10 animate-fade-in">
                  <div className="inline-flex items-center px-3 py-1 rounded-full border border-[#742aff]/20 bg-[#742aff]/5 text-[10px] font-bold tracking-widest text-[#742aff] mb-6 uppercase">
                  ...
                  <p className="text-[#8c8c94] text-lg max-w-2xl leading-relaxed">
                    Passive tracking of patterns and active tracking of objectives, indexed for personal evolution.
                  </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4 overflow-y-auto max-h-[400px] pr-4 custom-scrollbar mb-8">
                  <section className="p-6 rounded-[24px] border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] transition-all group">
                    <h3 className="text-xs font-bold tracking-widest text-[#8ab8ff] uppercase mb-6 flex items-center gap-2">
                      <div className="w-1 h-1 rounded-full bg-[#742aff]" />
                      Active Goals
                    </h3>
                ...
                <div className="w-full max-w-[700px] mt-auto mb-8 mx-auto">
                      ...
                      <div className="rounded-[19px] bg-[#050505] p-4 flex flex-col gap-4">
                        ...
                        <div className="flex items-center justify-between gap-4 mt-2">
                          <input 
                            ...
                            placeholder="Discuss your progress or set new benchmarks..."
                          />
