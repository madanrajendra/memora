...
import { Mail, Eye, EyeOff, User, Loader2, AlertCircle } from 'lucide-react';
      ...
      <div className="relative rounded-[24px] p-[1px] bg-gradient-to-b from-white/20 via-white/5 to-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.36)]">
        ...
        <div className="bg-[#06070A]/40 backdrop-blur-xl rounded-[23px] p-8 md:p-10 w-full">
          ...
          <div className="mt-8 text-center">
            <span className="text-white/60 font-dm text-sm">Already have an account? </span>
            <Link to="/login" className="text-[#38bdf8] hover:text-white font-dm text-sm transition-colors">
              Log In
            </Link>
          </div>
